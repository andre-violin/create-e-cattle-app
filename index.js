...
async function main() {
  let gitCheckoutCommand = `git clone --depth 1 https://github.com/andre-violin/e-cattle-`;
  console.clear();
      ...
      type: ({ results }) =>
        p.select({
          ...
          options: [
            ...
            { value: 'host', label: 'Host - Vue.js, Vuetify and Vite' },
            { value: 'remote', label: 'Remote - Vue.js, Vuetify and Vite' },
          ],
        }),
      install: () =>
        p.confirm({
